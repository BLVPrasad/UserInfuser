...
public class UserInfuser{
	 ...
	 */
	public String updateUser(final String userId)
	{
	 ...
	 * @return True on success, false otherwise.
	 */
	public String updateUser(final String userId, String userName, String linkToProfile, String linkToProfileImage)
	{
		if (userId == null)
		{
		...
		System.out.println("UpdateUser ====== "+response);
	 ...
	 */
	public String awardBadge(final String userId, final String badgeId)
	{
	 ...
	 * @return true on success.
	 */
	public String awardBadge(final String userId, final String badgeId, String reason, String resource)
	{
		...
		final String response = doPost(targetPath, params);
		System.out.println("awardBadge ====== "+response);
		return response;
	}
	 ...
	 * @return true on success.
	 */
	public String removeBadge(final String userId, final String badgeId)
	{
		if (userId == null || badgeId == null)
		{
			return badgeId;
	 ...
	 * @return true on success.
	 */
	public String awardPoints(final String userId, final int pointsAwarded)
	{
	 ...
	 * @return true on success.
	 */
	public String awardPoints(final String userId, final int pointsAwarded, String reason)
	{
		if (userId == null)
		{
			return userId;
		...
		final String response = doPost(targetPath, params);
		System.out.println("AwardPoints  =====  "+response);
		return response;
	}
	...
	public boolean awardBadgePoints(final String userId, final int pointsAwarded, final String badgeId, final int pointsRequired, String reason, String resource)
	{
		...
		final String response = doPost(targetPath, params);
		System.out.println("awardBadgePoints === "+  response);
		return true;
	}
	...
	{
		return _getWidget(userId, widgetType, "100%", "100%");
	}
	...
	private String _doPost(final String urlStr, final Map<String, String> params)
	{
		...
		try
		{
			...
			systemProperties.setProperty("http.proxyHost","192.168.145.80");
